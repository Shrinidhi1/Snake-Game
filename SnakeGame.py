...
def main():
    ...
    while(endgame!=1):
        ...
        # print(str(mySnake.x) + ' ' + str(mySnake.y))
        ...
        for myApple in apples:
            if(myApple.state == 1):
                if(checkCollision(mySnake.getHead(),SNAKE_SIZE,myApple,APPLE_SIZE)==True):
                    ...
                    score+=5
                    eaten_apple=True
                    # print(str(myApple.x) + ' ' + str(myApple.y))
    ...
    print(str(SCREEN_HEIGHT) + ' ' + str(SCREEN_WIDTH))
    # Snake Mid-Body
    print(str(mySnake.stack[int(len(mySnake.stack)/2)].x) + ' ' + str(mySnake.stack[int(len(mySnake.stack)/2)].y))
    # Snake Tail
    print(str(mySnake.stack[-1].x) + ' ' + str(mySnake.stack[-1].y))
